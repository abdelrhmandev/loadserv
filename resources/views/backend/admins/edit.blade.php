            ...
            <div class="card-header border-0">
                ...
                <div class="card-body border-top p-6">
                    <div class="d-flex flex-column gap-5">
                            ...
                            @foreach ($roles as $role)
                                <label class="form-check form-check-custom form-check-solid align-items-start">
                                    <input class="form-check-input me-3" type="checkbox" id="roles" name="roles[]"
                                        value="{{ $role }}" required @if(in_array($role,$adminRole)) checked @endif
                        ...
                        <div class="fv-row fl">
                            <label class="required form-label" for="is_active">{{ __('site.is_active') }}</label>
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                <span class="p-2">{{ __('site.active') }}</span>
                                <input class="form-check-input" type="checkbox" value="1" name="is_active" {{ isset($row->is_active) && $row->is_active == '1' ? 'checked':'' }}>
                            </div>
                        </div>
