@if (Auth::guard('admin')->user()->hasAnyPermission([$trans . '-edit', $trans . '-delete'], 'admin'))
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
        ...
        @if (Auth::guard('admin')->user()->can([$trans . '-edit'], 'admin'))
        ...
        @if (Auth::guard('admin')->user()->can([$trans . '-delete'], 'admin'))
            <div class="menu-item px-3">
                ...
                <a id="delete_item" data-destroy-route="{{ $destroyRoute }}" class="menu-link px-3"
                    data-kt-table-filter="delete_row" data-id="{{ $id }}"
