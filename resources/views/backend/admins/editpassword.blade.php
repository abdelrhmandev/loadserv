...
@section('breadcrumbs')
<h1 class="d-flex align-items-center text-gray-900 fw-bold my-1 fs-3">{{ __('user.plural') }}</h1>
...
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-dark">{{ __('site.edit') . ' ' . __('user.singular'). ' ' .__('site.password') }}</li>
</ul>
@stop
@section('style')
